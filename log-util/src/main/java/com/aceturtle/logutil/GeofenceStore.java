/* ************************************************
 * CopyRight Aceturtle All rights reserved
 *
 * Filename:	GeofenceStore.java
 * Created by:  Lediya
 * Description
 * ************************************************/
...
public class GeofenceStore implements ConnectionCallbacks,
     ...
     */
    private static ArrayList<Geofence> mGeofences;
...
// We want the location to be as accurate as possible.
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (mGoogleApiClient.isConnected() && mGeofences.size() != 0) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                if (ContextCompat.checkSelfPermission(mContext.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(mContext.getApplicationContext(), Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
    ...
    /* remove geofence location from store and disconnecting google api client */
    public static void disconnect() {
        // TODO Auto-generated method stub
        if (mGoogleApiClient!=null&&mGoogleApiClient.isConnected()){
            mGoogleApiClient.disconnect();
            mGeofences.removeAll(mGeofences);
        }
